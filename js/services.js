...
angular.module('openWeatherApp.services', ['ngResource'])
  ...
  //
  .value('exampleLocations',['Kampala','Nairobi','Kigali','Cairo','Tokyo','New York','Moscow','Thailand'])
  //
  // Storm "Xaver" special locations
  //
  .value('stormLocations',['Kampala','Nairobi','Lagos','Cairo','Hamburg','New York','Rome'])
  ...
  .factory('openWeatherMap', function($resource) {
    ...
    var apiKey = '904470b30468215864c8c2f458f07767';
